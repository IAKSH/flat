...
namespace flat::ni
{
	...
	{
		std::array<Vec2, 4> vertices1 = { Vec2{x1,y1},Vec2{x1 + w1,y1},Vec2{x1 + w1,y1 + h1},Vec2{x1,y1 + h1} };
		std::array<Vec2, 4> vertices2 = { Vec2{x2,y2},Vec2{x2 + w2,y2},Vec2{x2 + w2,y2 + h2},Vec2{x2,y2 + h2} };
