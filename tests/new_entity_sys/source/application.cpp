...
void quick3d::test::TestPass::load_cube_mesh() noexcept(false)
{
    ...
    cube_mesh->get_textures().push_back(new gl::MeshTexturePack("container2.png", "D:/Programming-Playground/quick3d/tests/new_entity_sys/image", "texture_diffuse"));
}
...
void quick3d::test::TestPass::exec() noexcept(false)
{
    ...
    }
    {
        ...
        character_animator->update_animation(0.01f);
    }
}
