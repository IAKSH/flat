...
void flat::Physical::setPosition(const glm::vec3 &pos)
{
	position = pos;
}

void flat::Physical::addPosition(const glm::vec3 &vec)
{
	position += vec;
}

void flat::Physical::addVelocity(const glm::vec3 &vec)
{
	velocity += vec;
}

void flat::Physical::setVelocity(const glm::vec3 &vel)
{
	velocity = vel;
}
...
void flat::Physical::setHitboxOffset(const glm::vec3 &offset)
{
	hitboxOffset = offset;
}

void flat::Physical::addHitboxOffset(const glm::vec3 &vec)
{
	hitboxOffset += vec;
}